...
$langs = array(
	...
	'pref_automatically_approve_yes' => 'yes',
	'pref_automatically_approve_no' => 'no',
	...
	'2'=>array(
	'title' => 'Français',
	'pref_title' => 'Préférences de Gab Captcha',
	...
	'pref_automatically_approve_yes' => 'oui',
	'pref_automatically_approve_no' => 'non',
		...
		<fieldset class="options">
			...
			<fieldset style="margin-top: 20px;">
				...
				<select id="gc_automatically_approve" name="gc_automatically_approve" />
					<option value="yes"<?php echo $gc_automatically_approve=='yes' ? ' selected' : ''; ?>><?php echo $texts['pref_automatically_approve_yes']; ?></option>
					<option value="no"<?php echo $gc_automatically_approve=='no' ? ' selected' : ''; ?>><?php echo $texts['pref_automatically_approve_no']; ?></option>
				</select>
...
function gabcaptcha2_init($id)
{
	...
	+ '<label for="commentturing"><?php echo $gabcaptchaoutput; ?></label>'
